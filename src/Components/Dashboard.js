    ...
    <div className="min-h-screen bg-gray-100 font-sans">
      ...
      <div className="container mx-auto px-4 py-6 flex">
        <nav className="w-1/4 bg-white shadow rounded p-4">
          <ul>
            <li className="mb-4">
              <a href="#dashboard" className="text-blue-500 font-semibold">Dashboard</a>
            </li>
            <li className="mb-4">
              <a href="#report" className="text-gray-700 hover:text-blue-500">Report</a>
            </li>
            <li className="mb-4">
              <a href="#live" className="text-gray-700 hover:text-blue-500">Live</a>
            </li>
            <li className="mb-4">
              <a href="#statistics" className="text-gray-700 hover:text-blue-500">Statistics</a>
            </li>
            <li className="mb-4">
              <a href="#geo-fence" className="text-gray-700 hover:text-blue-500">Geo-Fence</a>
            </li>
          </ul>
        </nav>
        ...
        <main className="w-3/4 ml-6">
          <section id="general-analytics" className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">General Analytics</h2>
            <div className="grid grid-cols-4 gap-4">
              ...
              <div className="bg-white p-4 shadow rounded">
                ...
                <div className="text-2xl font-bold text-gray-900">23 / 12,445</div>
                <div className="text-gray-500">in the last hour</div>
              </div>
              <div className="bg-white p-4 shadow rounded">
                <div className="flex items-center">
          ...
          <section id="graphs" className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Violations and Recent Incidents</h2>
